...
import { UIchild } from "../constants/types";
import { EntryType, getTextFileContents } from "./file-system-utils";
...
export const generate_files = async ({
  ...
  if (built_ast) {
    ...
    // exportedTree_file/file_contents is ast-generated from the main-template
    ...
    // these are pre-made component files, exportedTree_file is ast-generated from the main-template
